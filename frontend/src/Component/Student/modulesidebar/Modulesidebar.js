  ...
  return (
    <motion.div
      ...
      <ul>
        ...
        <motion.span variants={linkVariants} to={"/dashboard/unapproved"}>Part1</motion.span>
        </li>
        <li>
       <Link to={"/dashboard/unapproved"}><FontAwesomeIcon icon={faCog} className='mx-1 text-light'/></Link>
       <motion.span variants={linkVariants} to={"/dashboard/unapproved"}>Part2</motion.span>
        </li>
        <li>
            <Link to="/dashboard/approved"> <FontAwesomeIcon icon={faCog} className='mx-1 text-light'/></Link>
            <motion.span variants={linkVariants} to={"/dashboard/unapproved"}>Part3</motion.span>
        </li>
      </ul>
    </motion.div>
  );
